...
// 진짜 진짜 지ㅏㄴ짜 중요한 부분
/*
  ...arr2과 같이 작성했을 때, arr2라는 배열 자체가 들어가는 것이 아니라, 배열 내부의 element들을 하나씩 가지고 온다고 생각하는 편이 여러분의 정신건강에 좋습니다.

  즉, let arr4 = [...arr2, ...arr1];
  은 외부에 []가 있는 것을 봤을 때 새로 배열을 생성한 것이고, 걱의 내부에 arr2의 element들을 순서대로 집어넣고, 그 다음 arr1의 element들을 순서대로 집어 넣어서 완성했다고 해석할 수 있습니다.
*/
...
// 즉 {} 내의 요소들은 객체의 key 값과 같아야하 ㅁ

console.log(fName);
console.log(lName);

let person = getPerson(); // 리턴값이 JS 객체이므로 person은 JS의 객체명이 됩니다.
